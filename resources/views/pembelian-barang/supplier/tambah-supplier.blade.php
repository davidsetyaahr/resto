        ...
        <div class="card">
            ...
            <form action="{{ route('supplier.store') }}" method="post">
              ...
              <div class="card-body">
                  ...
                  <input type="text" name="kode_supplier" value="{{old('kode_supplier')}}" class="form-control @error('kode_supplier') is-invalid @enderror">
                  @error('kode_supplier')
                  ...
                  <input type="text" name="nama_supplier" value="{{old('nama_supplier')}}" class="form-control @error('nama_supplier') is-invalid @enderror">
                  @error('nama_supplier')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
